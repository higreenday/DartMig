...
/**
 * <p>section-6Type complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="section-6Type">
 *   &lt;complexContent>
 ...
 *           &lt;/choice>
 *           &lt;element name="SECTION-7" type="{}section-7Type"/>
...
@XmlType(name = "section-6Type", propOrder = {
    "emphasis",
    "title",
    "subtitle",
    "cautionOrWARNINGOrP"
})
public class Section6Type {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "SECTION-7", type = Section7Type.class),
